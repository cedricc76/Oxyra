...
export function Signup() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!agreedToTerms) {
      setError('Anda harus menyetujui Terms & Privacy OXYRA');
      return;
    }
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Mulai pantau kualitas udara dengan AI
          </p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/50 dark:border-slate-800/50 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm text-slate-700 dark:text-slate-300 mb-2">
                Konfirmasi Password
              </label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2">
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="terms" className="text-sm text-slate-600 dark:text-slate-400">
                Saya menyetujui Terms & Privacy OXYRA
              </label>
            </div>
